...
(function() {
  ...
  function CanvasRenderingContext2D_(surfaceElement) {
    ...
    el.style.width =  surfaceElement.clientWidth + '%';
    el.style.height = surfaceElement.clientHeight + '%';
  ...
  contextPrototype.drawImage = function(image, var_args) {
    ...
    if (this.m_[0][0] != 1 || this.m_[0][1]) {
      ...
      vmlStr.push('padding:0 ', mr(max.x / Z), '% ', mr(max.y / Z),
                  '% 0;filter:progid:DXImageTransform.Microsoft.Matrix(',
                  filter.join(''), ", sizingmethod='clip');")
    } else {
      vmlStr.push('top:', mr(d.y / Z), '%;left:', mr(d.x / Z), '%;');
    }
